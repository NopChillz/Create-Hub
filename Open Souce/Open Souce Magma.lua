...
local win = VLib:Window("NopChillz", "Blox Fruit", Color3.fromRGB(252, 83, 83))
	  ...
	  Misc:Button("Redeem Code All",function()
	    local A_1 = "UPD14"
		local Event = game:GetService("ReplicatedStorage").Remotes.Redeem
		Event:InvokeServer(A_1)
		local A_1 = "Axiore"
		local Event = game:GetService("ReplicatedStorage").Remotes.Redeem
		Event:InvokeServer(A_1)
		local A_1 = "TantaiGaming"
		local Event = game:GetService("ReplicatedStorage").Remotes.Redeem
		Event:InvokeServer(A_1)
	  end)
       Misc:line()
      ...
      BuyItem:Toggle("Auto Buy Random Devil Fruit",false,function(v)
       ...
       Setting:Label("Credit | NopChillz")
